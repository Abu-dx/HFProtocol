...
public:
	...
	void Demode_PSKrealFSE(Ipp16s *pSrcDst,int nLeng,Ipp16s P,int FFTLen,Ipp32f TH1,Ipp32f TH2,Ipp16s *expout,
		int &outLeng,Ipp8u *outbyte,int &byteLeng,HeadType141B *headType,int &headNum);
	void Synchronization(Ipp32fc *FrameBuf,Ipp16s FrameLen,Ipp16s P,Ipp32fc *pUWsig,Ipp16s UWleng,int delayCma,
	...
	void DeHead(Ipp16s *BurstPos,int BurstNum,HeadType141B *headType,int &headNum);
	void Timing_ini();
